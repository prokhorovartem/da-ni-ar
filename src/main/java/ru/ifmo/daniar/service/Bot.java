...
public final class Bot extends TelegramLongPollingCommandBot {
    ...
    private SendMessage createMessage(Message inputMsg) {
        ...
        switch (inputMsgText) {
            ...
            case "Зачем этот бот?":
                return createOutputMsg(chatId, "Создавая этого бота, мы хотели сохранить для тебя частичку постироничной культуры ушедших 2010-х годов. Часто мемы, которые ты получишь от бота, будут глупыми или абсурдными. Но время от времени он будет выдавать настоящие шедевры. Наслаждайся! И обязательно поделись своим мемесом в нашем уютном чатике", menuKeyBoard);
            case "Поддержать":
